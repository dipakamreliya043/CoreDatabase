...
public func ShowLoaderWithMessage(message:String) {
    startActivityAnimating(size: CGSize(width:56, height:56), message: message, type: NVActivityIndicatorType.lineSpinFadeLoader, color: .white, padding: 2,isFromOnView: false)
}
...
public func SHOW_CUSTOM_LOADER() {
    startActivityAnimating(size: CGSize(width:56, height:56), message: nil, type: NVActivityIndicatorType.lineSpinFadeLoader, color: .white, padding: 2,isFromOnView: false)
}
...
public func ShowLoaderOnView() {
    startActivityAnimating(size: CGSize(width:56, height:56), message: nil, type: NVActivityIndicatorType.lineSpinFadeLoader, color: .white, padding: 2,isFromOnView: true)
}
...
private func startActivityAnimating(size: CGSize? = nil, message: String? = nil, type: NVActivityIndicatorType? = nil, color: UIColor? = nil, padding: CGFloat? = nil, isFromOnView:Bool) {
    ...
    activityContainer.backgroundColor = UIColor.black.withAlphaComponent(0.4)
